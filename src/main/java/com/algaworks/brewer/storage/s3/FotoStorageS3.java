...
public class FotoStorageS3 implements FotoStorage {
	...
	private static final String BUCKET = "brewer-aw";
	...
	public String salvar(MultipartFile[] files) {
		...
		if (files != null && files.length > 0) {
			...
			try {
				...
				System.out.println(Mac.getInstance("SHA1"));
				...
				throw new RuntimeException("Erro reconhecendo o algoritmo", e);
			}
	...
	public String getUrl(String foto) {
		if (!StringUtils.isEmpty(foto)) {
			return "https://brewer-aw.s3.sa-east-1.amazonaws.com/" + foto;
		}
